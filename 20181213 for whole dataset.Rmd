...
```
#####################
setwd("P:/NZR/NZR-001/Innovatieve Onderzoeksmethoden/2. Machine learning antibiotica bij ontstekingen/03. Dataverwerking/6. output R/20181213wqi/")
...
ps.balance
#write.table(ps.balance, file="P:/NZR/NZR-001/Innovatieve Onderzoeksmethoden/2. Machine learning antibiotica bij ontstekingen/03. Dataverwerking/6. output R/20181213wqi/ps.balance_ab.csv", sep = ",")
...
#### logistic univariate
```{r}
uni<-glm(outcome_4~AB_nose_infection, weights = outcome_weight, data= data_first_treatment_12ow_relevant_0.4, family = binomial)
...
#### logistic univariate
```{r}
uni_type<-glm(outcome_4 ~ factor(type_AB_nose),weights = outcome_weight, data= data_first_treatment_12ow_relevant_0.4, family = binomial)
...
mnp.balance
#write.table(mnp.balance, file="P:/NZR/NZR-001/Innovatieve Onderzoeksmethoden/2. Machine learning antibiotica bij ontstekingen/03. Dataverwerking/6. output R/20181213wqi/mnp.balance_type.csv", sep = ",")
...
PRIM <- subset(data_first_treatment_12ow_relevant_0.4, select = c(age, sex, nr_medication,COPD_morb, migraine_morb, nr_contacts_resp, osteop_morb,poor_immune_response, alcmisb_morb,practice_size, Depressie_morb,aangaf_morb,hartfalen_morb,flu_epi,season,postalcode, nr_contacts_infection, nr_prescriptions_AB, delta))
