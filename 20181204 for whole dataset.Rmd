...
onlynose <-read.csv(file = "researchfile_onlynose.csv", na.strings=c("NA","NaN", " ",""), colClasses="factor")

researchfile <-read.csv(file = "research file.csv", na.strings=c("NA","NaN", " ",""), colClasses="factor")

names(data_first_treatment)
names(onlynose)
names(researchfile)
...
#anti_fn <-anti_join(data_first_treatment, onlynose)
#semi_fn <-semi_join(data_first_treatment, onlynose)
...
data_first_treatment_12ow <- mutate(data_first_treatment,outcome_weight=ifelse(month(date)==12 & is.na(outcome_4),
