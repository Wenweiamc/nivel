...
# model 3
glm_type18_part_np <- svyglm(outcome_4 ~ type_AB_nose + season, design = design.mnps18, family=quasibinomial)

summary(glm_type18_part_np )
...
# model 3
glm_type10_part_np <- svyglm(outcome_4 ~ type_AB_nose + season, design = design.mnps10, family=quasibinomial)
...
# model 3
glm_type7_part_np <- svyglm(outcome_4 ~ type_AB_nose + season, design = design.mnps7, family=quasibinomial)

summary(glm_type7_part_np)

cbind( exp(coef(glm_type7_part_np)), exp(summary(glm_type7_part_np)$coefficients[,1] - 1.96*summary(glm_type7_part_np)$coefficients[,2]), exp(summary(glm_type7_part_np)$coefficients[,1] + 1.96*summary(glm_type7_part_np)$coefficients[,2]) )
