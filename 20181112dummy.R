...
vars_zero = lapply(data_first_treatment, var, na.rm = TRUE) != 0
vars_zero_names = names(vars_zero[vars_zero == FALSE])

# drop variables with variance = 0
data_first_treatment_v0<- dplyr::select(data_first_treatment,-one_of(vars_zero_names))

# remove dropped variables from variable selection
vars_relevant_nto_v0 <- intersect(vars_relevant_nto,names(data_first_treatment_v0)) 
...
data_first_treatment_relevant$AB<-0
data_first_treatment_relevant$AB[as.numeric(data_first_treatment_relevant$AB_nose_infection)==2]<-1
...
PS_Model<-ps(
  ...
  data = data_first_treatment_relevant,
  verbose = FALSE, 
  estimand = "ATE")
...
PRIM_1 <- subset(data_first_treatment_relevant_0.4_na.omit_v0, select = c(age, nr_medication, kanker_morb, coronhartz_morb,  RA_morb , alcmisb_morb ,
...
PRIM_2 <- subset(data_first_treatment_relevant_0.4_na.omit_v0, select = c(age, nr_medication, kanker_morb, coronhartz_morb,  RA_morb , alcmisb_morb ,
...
PRIM_3 <- subset(data_first_treatment_relevant_0.4_na.omit_v0, select = c(age, nr_medication, kanker_morb, coronhartz_morb,  RA_morb , alcmisb_morb ,
...
PRIM_4 <- subset(data_first_treatment_relevant_0.4_na.omit_v0, select = c(age, nr_medication, kanker_morb, coronhartz_morb,  RA_morb , alcmisb_morb ,
